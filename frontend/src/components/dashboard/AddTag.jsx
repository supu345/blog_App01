        ...
        <form onSubmit={addTag}>
          ...
          <div>
            {loader ? (
              ...
              <button className="bg-green-300 mt-2 px-2">Add Tag</button>
            )}
          </div>
        </form>
      </div>
